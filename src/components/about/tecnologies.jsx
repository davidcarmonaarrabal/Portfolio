...
const technologies = [
  ...
  { name: 'Neon', url: 'https://neon.tech/', image: '/img/techs/neon.png', category: 'Herramientas' },
...
export default function Technologies() {
  ...
  return (
    <section id="technologies" className="py-24 px-6 bg-white dark:bg-gray-950">
      <FadeIn>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-12">
            {grouped.map((group) => (
              <div
                key={group}
                className="rounded-3xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-6 sm:p-8"
              >
                  ...
                  {technologies
                    ...
                    .map((tech) => (
                      <a
                        ...
                        className="group w-24 h-24 p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center justify-center"
                        title={tech.name}
                      >
